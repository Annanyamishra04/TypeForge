...
export default function AchievementsErrorState({ message, onRetry }) {
  return (
    <div className="flex flex-col items-center gap-5 rounded-lg border border-dashed border-border-strong bg-surface/40 px-6 py-16 text-center sm:py-20">
      ...
      <div className="flex max-w-sm flex-col gap-2">
        <h3 className="text-lg font-semibold text-text-primary">Achievements unavailable</h3>
        <p className="text-sm leading-relaxed text-text-secondary">
          {message ||
            "Something went wrong reaching the server. Your progress is safe — this is just a connection issue."}
        </p>
      </div>
