/**
 * Local word bank for the typing test.
 *
 * This is intentionally a plain array of common, short-to-medium
 * English words with no external dependency. It is large enough that
 * repeated tests do not feel identical (random sampling + shuffling),
 * but small enough to ship as a static module.
 */
export const WORD_BANK = [
  "the", "of", "and", "to", "in", "a", "is", "that", "for", "it",
  "with", "as", "was", "on", "be", "at", "by", "this", "have", "from",
  "or", "one", "had", "not", "but", "what", "some", "we", "can", "out",
  ...
  "came", "show", "every", "good", "give", "our", "under", "name", "very", "through",
  ...
  "list", "though", "feel", "talk", "bird", "soon", "body", "family", "direct", "leave",
...
/**
 * Generation, punctuation, numbers, and duration-sizing logic lives in
 * `src/utils/textGeneration.js` — this file stays pure data so the
 * word bank can grow without touching any logic.
 */
